...
public class Room2NotificationSettingScreenController {
    ...
    @FXML
    void Room2ToggleTemperaturebutton(ActionEvent event) {
        // Toggle the humidity settings for Room 2
        boolean isActive = ToggleTemperatureButton.isSelected();
        System.out.println("Room 2 Temperature Notifications: " + (isActive ? "ON" : "OFF"));
        // Enable/disable the humidity notifications
    }
    @FXML
    void Room2ToggleHumiditybutton(ActionEvent event) {
        // Toggle the humidity settings for Room 2
        boolean isActive = ToggleHumiditybutton.isSelected();
        System.out.println("Room 2 Humidity Notifications: " + (isActive ? "ON" : "OFF"));
        // Enable/disable the humidity notifications
    }

    @FXML
    void Room2ToggleNoisebutton(ActionEvent event) {
        // Toggle the noise settings for Room 2
        boolean isActive = ToggleNoisebutton.isSelected();
        System.out.println("Room 2 Noise Notifications: " + (isActive ? "ON" : "OFF"));
        // Enable/disable the humidity notifications
    }
